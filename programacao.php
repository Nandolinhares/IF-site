...
<head>
	...
	<!-- Title -->
	<title>Programação - Invasão Fantástica</title>

	<!-- Open Graph tags -->
	<meta property="og:title" content="Programação - Invasão Fantástica"/>
	<meta property="og:type" content="website"/>
	<meta property="og:url" content="programação.php"/>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-12 col-sm-6 col-md-6 col-lg-6">
					<a href="beco.php"><img class="box1" src="photos/IF/boxBeco.png"></a>
				</div>
				<div class="col-12 col-sm-6 col-md-6 col-lg-6">
					<a href="paineis.php"><img class="box1" src="photos/IF/boxPaineis.png"></a>
				</div>
			</div>
			<div style="margin-top: 2%;" class="row">
				<div class="col-12 col-sm-6 col-md-6 col-lg-6">
					<a href="areaGamer.php"><img class="box1" src="photos/IF/boxAreaGamer.png"></a>
				</div>
				<div class="col-12 col-sm-6 col-md-6 col-lg-6">
					<a href="justdance.php"><img class="box1" src="photos/IF/boxJD.png"></a>
				</div>
			</div>
		</div>		
	</section>
