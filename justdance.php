...
<head>
	...
	<!-- Title -->
	<title>Just Dance - Invasão Fantástica</title>

	<!-- Open Graph tags -->
	<meta property="og:title" content="Just Dance - Invasão Fantástica"/>
	<meta property="og:type" content="website"/>
	<meta property="og:url" content="justdance.php"/>
...
<body>
	...
	<section class="paineis">
		<div class="container">
			<img src="photos/IF/pages/pageJD.png">
			<h1>Em Breve  ...</h1>
		</div>		
	</section>
