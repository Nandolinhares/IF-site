...
<head>
	...
	<!-- Title -->
	<title>Convidados - Invasão Fantástica</title>

	<!-- Open Graph tags -->
	<meta property="og:title" content="Convidados - Invasão Fantástica"/>
	<meta property="og:type" content="website"/>
	<meta property="og:url" content="convidados.php"/>
...
<body>
	...
	<section class="paineis">
		<div class="container">
			<img src="photos/IF/pages/pageConvidados.png">
			<h1>Em Breve  ...</h1>
		</div>		
	</section>
