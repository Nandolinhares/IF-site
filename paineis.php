...
<head>
	...
	<!-- Title -->
	<title>Painéis - Invasão Fantástica</title>

	<!-- Open Graph tags -->
	<meta property="og:title" content="Painéis - Invasão Fantástica"/>
	<meta property="og:type" content="website"/>
	<meta property="og:url" content="paineis.php"/>
...
<body>
	...
	<section class="paineis">
		<div class="container">
			...
			<div class="row artistas">
				<div class="col-12 col-sm-12 col-md-12 col-lg-5">
					<h2 style="margin-top: 8%;">Workshop de Quadribol</h2>
					<p class="bioConvidados">A ABRQ (Associação Brasileira de Quadribol) tem por objetivo difundir, organizar e fortalecer o Quadribol em todo o território nacional. Além disso, visamos representar as equipes e jogadores de quadribol, perante as comunidades brasileira e internacional e desenvolver o esporte no país.
					</p>
				</div>
				<div class="col-12 col-sm-0 col-md-0 col-lg-7">
