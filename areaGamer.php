...
<head>
	...
	<!-- Title -->
	<title>Área Gamer - Invasão Fantástica</title>

	<!-- Open Graph tags -->
	<meta property="og:title" content="Área Gamer - Invasão Fantástica"/>
	<meta property="og:type" content="website"/>
	<meta property="og:url" content="areaGamer.php"/>
...
<body>
	...
	<section class="beco">
		<div class="container">
			<img src="photos/IF/pages/pageAreaGamer.png">
			<h1 style="font-family: Stanley Demo; color: #fff; text-align: center;">Em Breve  ...</h1>
		</div>		
	</section>
